...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#4F6072] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          {!ready ? (
            ...
            <>
              <h1 className="text-xl font-semibold text-[#4F6072] mb-2">Nouveau mot de passe</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#4F6072]"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#4F6072] text-white rounded-lg py-2 text-sm font-medium hover:bg-[#4F6072]/90 disabled:opacity-50 transition-colors"
                >
