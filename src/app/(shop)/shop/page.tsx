              ...
              <div className="text-center lg:text-left lg:order-1">
                <Reveal>
                  ...
                  <p className="mt-3 text-charcoal/50 text-sm">
                    merci murphy®, c&apos;est aussi un dog shop engagé. Nos achats ont un sens —
                    pour nos poilus et pour la planète.
                  </p>
                </Reveal>
                ...
                <div className="mt-8 space-y-5 text-sm text-charcoal/70 leading-relaxed">
                  <Reveal delay={100}>
                    <div className="flex gap-3">
                      ...
                      <p>
                        Le collectif{' '}
                        <span className="text-charcoal font-medium">merci murphy®</span> vous
                        propose une offre resserrée de produits, choisis strictement pour leurs
                        bénéfices pour votre chien et selon des critères exigeants éco-responsables
                        et éthiques. Cela signifie questionner la composition, toutes les étapes de
                  ...
                  <Reveal delay={200}>
                    <div className="flex gap-3">
                      ...
                      <p>
                        <span className="text-charcoal font-medium">merci murphy®</span> aime le
                        vrai et les savoir-faire des passionnés. La plupart de nos
                        fournisseurs-partenaires sont des artisans locaux. Nos produits voyagent le
                        moins possible — fabrication engagé pour favoriser la mixité dans
                        l&apos;entreprenariat. Nous favorisons les marques dirigées par des femmes.{' '}
                  ...
                  <Reveal delay={300}>
                    <div className="flex gap-3">
                      ...
                      <p>
                        ...
                        — entrent dans la sélection. Pas de souffrance animale : vous ne trouverez
                        pas de cuir animal chez{' '}
