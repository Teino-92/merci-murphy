    ...
    <div className="text-center lg:text-left lg:order-1">
      <Reveal>
        ...
        <button
          ...
          className="mt-3 lg:hidden inline-flex items-center gap-1 text-sm font-medium text-terracotta-dark"
        >
      ...
      <div
        className={`mt-8 space-y-5 text-sm text-charcoal/70 leading-relaxed ${expanded ? '' : 'hidden lg:block'}`}
      >
        <Reveal delay={100}>
          <div className="flex gap-3">
            ...
            <p>
              ...
              propose une offre resserrée de produits, choisis strictement pour leurs bénéfices pour
              votre chien et selon des critères exigeants éco-responsables et éthiques. Cela
              signifie questionner la composition, toutes les étapes de réalisation et la durabilité
              de chaque produit.
            </p>
          </div>
        </Reveal>
        <Reveal delay={200}>
          <div className="flex gap-3">
            ...
            <p>
              ...
              par des femmes.{' '}
              <span className="not-italic font-medium text-charcoal">merci murphy®</span> est engagé
              pour favoriser la mixité dans l&apos;entreprenariat. Nous favorisons les marques
        ...
        <Reveal delay={400}>
          <div className="flex gap-3">
            ...
            <p>
              ...
              <span className="text-charcoal font-medium">second-hand</span> et une consommation en
              vrac. Réutiliser est la meilleure option pour la planète — pour une consommation
